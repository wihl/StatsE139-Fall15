...
Assumes independence of study units and groups, nonparametric. Does assume similar shapes and spreads.
...
Robustness: able to be useful when assumptions are violated. 
